...
var Pagination = function Pagination(_ref) {
    ...
    return _react2.default.createElement(
        ...
        (0, _pagination2.default)({ total: total, activePage: activePage }).map(function (page, index) {
            return _react2.default.createElement(
                'li',
                { key: index, className: activePage === page ? 'activePage' : null },
                _react2.default.createElement(_page2.default, { page: page, pageLink: pageLink.replace('%page%', page), handleClick: handleClick })
            );
        })
    );
};
...
*/
var aa=__webpack_require__(1),p=__webpack_require__(10),ba=__webpack_require__(22);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var App = function (_Component) {
    ...
    function App() {
        ...
        _this.getNoticiasEmDestaque = function (lastPage) {
            _axios2.default.get('https://newsapi.org/v2/everything?q=all&apiKey=06db68aceab74650ac3f9411c46e0796&pageSize=7&page=' + lastPage).then(function (response) {
                console.log(response.data.articles);
                _this.setState({
                    noticiasEmDestaque: {
                        request: response.data.articles.map(function (item, index) {
                            return {
                                title: item.title,
        ...
        _this.getNoticiasDoBrasil = function (lastPage) {
            ...
            _axios2.default.get('https://newsapi.org/v2/top-headlines?country=br&apiKey=06db68aceab74650ac3f9411c46e0796&pageSize=7&page=' + lastPage).then(function (response) {
                _this.setState({
                    noticiasDoBrasil: {
                        request: response.data.articles.map(function (item, index) {
                            return {
        ...
        _this.getNoticiasDoEua = function (lastPage) {
            _axios2.default.get('https://newsapi.org/v2/top-headlines?country=us&apiKey=06db68aceab74650ac3f9411c46e0796&pageSize=7&page=' + lastPage).then(function (response) {
                _this.setState({
                    noticiasDoEua: {
                        request: response.data.articles.map(function (item, index) {
                            return {
        ...
        _this.getNoticiasDaArgentina = function (lastPage) {
            _axios2.default.get('https://newsapi.org/v2/top-headlines?country=ar&apiKey=06db68aceab74650ac3f9411c46e0796&pageSize=7&page=' + lastPage).then(function (response) {
                _this.setState({
                    noticiasDaArgentina: {
                        request: response.data.articles.map(function (item, index) {
                            return {
        ...
        _this.getNoticiasDaFranca = function (lastPage) {
            _axios2.default.get('https://newsapi.org/v2/top-headlines?country=fr&apiKey=06db68aceab74650ac3f9411c46e0796&pageSize=7&page=' + lastPage).then(function (response) {
                _this.setState({
                    noticiasDaFranca: {
                        request: response.data.articles.map(function (item, index) {
                            return {
        ...
        _this.componentDidMount = function () {
            ...
            var lastPage = +page[page.length - 1];
            if (isNaN(lastPage)) {
                lastPage = 1;
            }
            _this.getNoticiasEmDestaque(lastPage);
            _this.getNoticiasDoBrasil(lastPage);
            _this.getNoticiasDoEua(lastPage);
            _this.getNoticiasDaArgentina(lastPage);
            _this.getNoticiasDaFranca(lastPage);
        };

        _this.refreshPage = function () {
            _this.getNoticiasEmDestaque(1);
            _this.getNoticiasDoBrasil(1);
            _this.getNoticiasDoEua(1);
            _this.getNoticiasDaArgentina(1);
            _this.getNoticiasDaFranca(1);
        ...
        _this.handleRefreshAndClose = function () {
            _this.refreshPage();
...
var AppContent = function AppContent(_ref) {
    var noticiasEmDestaque = _ref.noticiasEmDestaque,
        noticiasDoBrasil = _ref.noticiasDoBrasil,
        noticiasDoEua = _ref.noticiasDoEua,
        noticiasDaArgentina = _ref.noticiasDaArgentina,
        noticiasDaFranca = _ref.noticiasDaFranca,
        pagination = _ref.pagination,
        refreshAll = _ref.refreshAll,
        refreshBr = _ref.refreshBr,
        refreshEua = _ref.refreshEua,
        refreshAr = _ref.refreshAr,
        refreshFr = _ref.refreshFr,
        openMenu = _ref.openMenu,
        openSearch = _ref.openSearch,
        handleOpenMenu = _ref.handleOpenMenu,
        handleCloseMenu = _ref.handleCloseMenu,
        handleOpenSearch = _ref.handleOpenSearch,
        handleCloseSearch = _ref.handleCloseSearch;
    return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_header2.default, { handleOpenMenu: handleOpenMenu, openSearch: openSearch, handleOpenSearch: handleOpenSearch, handleCloseSearch: handleCloseSearch }),
...
var Header = function Header(_ref) {
    var handleOpenMenu = _ref.handleOpenMenu,
        handleOpenSearch = _ref.handleOpenSearch,
        handleCloseSearch = _ref.handleCloseSearch,
        openSearch = _ref.openSearch;
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'header__desktop--wrapper flexHorizontalVertical' },
                    _react2.default.createElement('a', { href: url(), className: 'header__logo' }),
                    _react2.default.createElement(
                        'div',
                        { className: 'header__search--wrapper' },
                        _react2.default.createElement('input', { id: 'inputSearchDesktop', className: 'header__search', type: 'search' }),
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: !openSearch ? 'header__mobile--wrapper flexHorizontalVertical' : "header__mobile--wrapperClosed" },
                _react2.default.createElement('i', { onClick: handleOpenMenu, 'class': 'fas fa-bars' }),
                _react2.default.createElement('a', { href: url(), className: 'header__logo' }),
                _react2.default.createElement('i', { onClick: handleOpenSearch, 'class': 'fas fa-search' })
            ),
            _react2.default.createElement(
                'div',
                { className: openSearch ? 'header__mobile--wrapper--search' : "header__mobile--wrapper--searchClosed" },
                _react2.default.createElement(
                    'div',
                    { className: 'header__search--wrapper' },
                    _react2.default.createElement('input', { className: 'header__search', type: 'search' }),
                    _react2.default.createElement('i', { 'class': 'fas fa-search' })
                ),
                _react2.default.createElement(
                    'div',
                    { onClick: handleCloseSearch, className: 'buttonCloseSearch' },
...
var Nav = function Nav(_ref) {
    ...
    return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { to: '/noticias-em-destaque' },
                            'not\xEDcias em destaque'
                        )
                    ),
                    _react2.default.createElement(
                        'li',
                        ...
                        _react2.default.createElement(
                            _reactRouterDom.Link,
                            { to: '/noticias-do-brasil' },
                            'not\xEDcias do brasil'
                        ),
                        ' '
                    ),
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _reactRouterDom.Link,
                            { to: '/noticias-da-argentina' },
                            'not\xEDcias da argentina'
                        ),
                        ' '
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _reactRouterDom.Link,
                            { to: '/noticias-da-franca' },
                            'not\xEDcias da fran\xE7a'
                        ),
                        ' '
                    )
                )
        ...
        _react2.default.createElement(
            'nav',
            { className: openMenu ? 'nav__mobile' : 'nav__mobile--closed' },
            _react2.default.createElement(
                'ul',
                null,
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: refreshAll, to: '/noticias-em-destaque' },
                        'not\xEDcias em destaque'
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: refreshBr, to: '/noticias-do-brasil' },
                        'not\xEDcias do brasil'
                    ),
                    ' '
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: refreshEua, to: '/noticias-do-eua' },
                        'not\xEDcias do eua'
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: refreshAr, to: '/noticias-da-argentina' },
                        'not\xEDcias da argentina'
                    ),
                    ' '
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: refreshFr, to: '/noticias-da-franca' },
                        'not\xEDcias da fran\xE7a'
                    ),
                    ' '
                )
        ...
        _react2.default.createElement(
            'div',
            { onClick: handleCloseMenu, className: openMenu ? 'buttonClose' : 'nav__mobile--closed' },
            _react2.default.createElement('i', { 'class': 'fas fa-times' })
        ),
        _react2.default.createElement('div', { className: openMenu ? 'wrapperOpen' : 'wrapperOpenClosed' })
    );
};
...
var _noticiasEmDestaque = __webpack_require__(33);

var _noticiasEmDestaque2 = _interopRequireDefault(_noticiasEmDestaque);

var _noticiasDoBrasil = __webpack_require__(37);

var _noticiasDoBrasil2 = _interopRequireDefault(_noticiasDoBrasil);

var _noticiasDoEua = __webpack_require__(39);

var _noticiasDoEua2 = _interopRequireDefault(_noticiasDoEua);

var _noticiasDaArgentina = __webpack_require__(41);

var _noticiasDaArgentina2 = _interopRequireDefault(_noticiasDaArgentina);

var _noticiasDaFranca = __webpack_require__(43);

var _noticiasDaFranca2 = _interopRequireDefault(_noticiasDaFranca);
...
var Routes = function Routes(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: function render() {
                return _react2.default.createElement(_reactRouterDom.Redirect, { to: '/noticias-em-destaque' });
            } }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/noticias-em-destaque', render: function render() {
                return _react2.default.createElement(_noticiasEmDestaque2.default, { noticiasEmDestaque: noticiasEmDestaque, pagination: pagination });
            } }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/noticias-do-brasil', render: function render() {
                return _react2.default.createElement(_noticiasDoBrasil2.default, { noticiasDoBrasil: noticiasDoBrasil, pagination: pagination });
            } }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/noticias-do-eua', render: function render() {
                return _react2.default.createElement(_noticiasDoEua2.default, { noticiasDoEua: noticiasDoEua, pagination: pagination });
            } }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/noticias-da-argentina', render: function render() {
                return _react2.default.createElement(_noticiasDaArgentina2.default, { noticiasDaArgentina: noticiasDaArgentina, pagination: pagination });
            } }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/noticias-da-franca', render: function render() {
                return _react2.default.createElement(_noticiasDaFranca2.default, { noticiasDaFranca: noticiasDaFranca, pagination: pagination });
            } })
    );
};
...
var _noticiasCard = __webpack_require__(34);

var _noticiasCard2 = _interopRequireDefault(_noticiasCard);
...
var renderUrl = function renderUrl() {
    ...
    var urlSplitada = url.split('/page/');
    // console.log(urlSplitada[0])
    return urlSplitada[0] + '/page/%page%';
};

var NoticiasEmDestaque = function NoticiasEmDestaque(_ref) {
    var noticiasEmDestaque = _ref.noticiasEmDestaque,
        pagination = _ref.pagination;
    return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(_noticiasCard2.default, { noticiasEmDestaque: noticiasEmDestaque }),
...
exports.default = NoticiasEmDestaque;
...
var formatDate = function formatDate(date) {
    ...
    var dayFormated = date.split(':');
    var dayFinal = dayFormated[0].split('-')[2].replace('T', '-').split('-')[0];
    return dayFinal + '-' + dateFormated[1] + '-' + dateFormated[0];
};

var NoticiasCard = function NoticiasCard(_ref) {
    var noticiasEmDestaque = _ref.noticiasEmDestaque;
    return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasEmDestaque.request.slice(0, 2).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
                    _react2.default.createElement(
                        'span',
                        null,
                    ...
                    _react2.default.createElement(
                        'span',
                        null,
                        'Por: ' + (item.author ? item.author : 'Desconhecido')
                    )
                );
            })
        ),
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--threeDivs' },
            noticiasEmDestaque.request.slice(2, 5).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper--three', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
                    _react2.default.createElement(
                        'span',
                        null,
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasEmDestaque.request.slice(5, 7).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
...
var Page = function Page(_ref) {
    ...
    var Component = page === '...' ? Dots : 'a';
    return _react2.default.createElement(
        Component,
        { href: pageLink, onClick: handleClick },
        page
    );
};
...
var _noticiasCard = __webpack_require__(38);
...
var NoticiasDoBrasil = function NoticiasDoBrasil(_ref) {
    var noticiasDoBrasil = _ref.noticiasDoBrasil,
        pagination = _ref.pagination;
    return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(_noticiasCard2.default, { noticiasDoBrasil: noticiasDoBrasil }),
        _react2.default.createElement(_pagination2.default, {
            total: pagination.total,
            activePage: pagination.activePage,
            pageLink: renderUrl()
...
exports.default = NoticiasDoBrasil;
...
var NoticiasCard = function NoticiasCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasDoBrasil.request.slice(0, 2).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--threeDivs' },
            noticiasDoBrasil.request.slice(2, 5).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper--three', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasDoBrasil.request.slice(5, 7).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
...
var _noticiasCard = __webpack_require__(40);
...
var noticiasDoEua = function noticiasDoEua(_ref) {
    var noticiasDoEua = _ref.noticiasDoEua,
        pagination = _ref.pagination;
    return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(_noticiasCard2.default, { noticiasDoEua: noticiasDoEua }),
        _react2.default.createElement(_pagination2.default, {
            total: pagination.total,
            activePage: pagination.activePage,
            pageLink: renderUrl()
...
var NoticiasCard = function NoticiasCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasDoEua.request.slice(0, 2).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--threeDivs' },
            noticiasDoEua.request.slice(2, 5).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper--three', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasDoEua.request.slice(5, 7).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
...
var _noticiasCard = __webpack_require__(42);
...
var NoticiasDaArgentina = function NoticiasDaArgentina(_ref) {
    var noticiasDaArgentina = _ref.noticiasDaArgentina,
        pagination = _ref.pagination;
    return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(_noticiasCard2.default, { noticiasDaArgentina: noticiasDaArgentina }),
        _react2.default.createElement(_pagination2.default, {
            total: pagination.total,
            activePage: pagination.activePage,
            pageLink: renderUrl()
...
exports.default = NoticiasDaArgentina;
...
var NoticiasCard = function NoticiasCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasDaArgentina.request.slice(0, 2).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--threeDivs' },
            noticiasDaArgentina.request.slice(2, 5).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper--three', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasDaArgentina.request.slice(5, 7).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
...
var _noticiasCard = __webpack_require__(44);
...
var NoticiasDaFranca = function NoticiasDaFranca(_ref) {
    var noticiasDaFranca = _ref.noticiasDaFranca,
        pagination = _ref.pagination;
    return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(_noticiasCard2.default, { noticiasDaFranca: noticiasDaFranca }),
        _react2.default.createElement(_pagination2.default, {
            total: pagination.total,
            activePage: pagination.activePage,
            pageLink: renderUrl()
...
exports.default = NoticiasDaFranca;
...
var NoticiasCard = function NoticiasCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasDaFranca.request.slice(0, 2).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--threeDivs' },
            noticiasDaFranca.request.slice(2, 5).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper--three', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
        ...
        _react2.default.createElement(
            'div',
            { className: 'noticias__wrapper--twoDivs' },
            noticiasDaFranca.request.slice(5, 7).map(function (item, index) {
                return _react2.default.createElement(
                    'a',
                    { href: item.url, className: 'noticias__wrapper', target: '_blank' },
                    _react2.default.createElement('img', { src: item.img ? item.img : 'https://i.imgur.com/i1emgCQ.jpg' }),
...
var Footer = function Footer() {
    return _react2.default.createElement(
        "footer",
        null,
        _react2.default.createElement("a", { href: "http://www.webedia.com.br/", target: "_blank", className: "footer__logo" })
    );
};
